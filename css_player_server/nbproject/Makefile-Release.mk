...
${OBJECTDIR}/include/css_monitor.h.gch: include/css_monitor.h 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o "$@" include/css_monitor.h

${OBJECTDIR}/main/cli.o: main/cli.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/cli.o main/cli.c

${OBJECTDIR}/main/config.o: main/config.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/config.o main/config.c

${OBJECTDIR}/main/css_monitor.o: main/css_monitor.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/css_monitor.o main/css_monitor.c

${OBJECTDIR}/main/cssmm.o: main/cssmm.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/cssmm.o main/cssmm.c

${OBJECTDIR}/main/cssobj2.o: main/cssobj2.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/cssobj2.o main/cssobj2.c

${OBJECTDIR}/main/cssplayer.o: main/cssplayer.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/cssplayer.o main/cssplayer.c

${OBJECTDIR}/main/io.o: main/io.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/io.o main/io.c

${OBJECTDIR}/main/localtime.o: main/localtime.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/localtime.o main/localtime.c

${OBJECTDIR}/main/lock.o: main/lock.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/lock.o main/lock.c

${OBJECTDIR}/main/logger.o: main/logger.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/logger.o main/logger.c

${OBJECTDIR}/main/md5.o: main/md5.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/md5.o main/md5.c

${OBJECTDIR}/main/netsock2.o: main/netsock2.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/netsock2.o main/netsock2.c

${OBJECTDIR}/main/sha1.o: main/sha1.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/sha1.o main/sha1.c

${OBJECTDIR}/main/strcompat.o: main/strcompat.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/strcompat.o main/strcompat.c

${OBJECTDIR}/main/strings.o: main/strings.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/strings.o main/strings.c

${OBJECTDIR}/main/sysloger.o: main/sysloger.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/sysloger.o main/sysloger.c

${OBJECTDIR}/main/term.o: main/term.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/term.o main/term.c

${OBJECTDIR}/main/threadstorage.o: main/threadstorage.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/threadstorage.o main/threadstorage.c

${OBJECTDIR}/main/utils.o: main/utils.c 
	${MKDIR} -p ${OBJECTDIR}/main
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main/utils.o main/utils.c
