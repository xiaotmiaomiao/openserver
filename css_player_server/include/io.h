 ...
 * Author: root
 *
 * Created on April 21, 2014, 12:58 AM
 */
...
/*! Input ready */
#define CSS_IO_IN 	POLLIN
/*! Output ready */
#define CSS_IO_OUT 	POLLOUT
/*! Priority input ready */
#define CSS_IO_PRI	POLLPRI

/* Implicitly polled for */
/*! Error condition (errno or getsockopt) */
#define CSS_IO_ERR	POLLERR
/*! Hangup */
#define CSS_IO_HUP	POLLHUP
/*! Invalid fd */
#define CSS_IO_NVAL	POLLNVAL

/*! \brief
 * An Ceictims IO callback takes its id, a file descriptor, list of events, and
...
typedef int (*css_io_cb)(int *id, int fd, short events, void *cbdata);
#define CSS_IO_CB(a) ((css_io_cb)(a))
 ...
 * \retval -1 on failure
 */
int css_io_remove(struct io_context *ioc, int *id);
 ...
 * Call with result from previous css_hide_password
 */
int css_restore_tty(int fd, int oldstatus);
